...
<body>
    <div class="order-details-admin-container">
    	<a href="<%= request.getContextPath() %>/admin/orders" class="back-link">&larr; Back to Orders</a>
        <div class="admin-section-title">Order Details </div>
                ...
                <tbody>
                  <% for (OrderItemDTO item: order_details.getOrderItemDTO()) { %>
                    <tr>
                        ...
                        <td><%= (item.getProduct() != null && item.getProduct().getStock_quantity() > 0) ? "Available" : "Out of Stock" %></td>
                    </tr>
                   <% } %>
                </tbody>
            </table>
        ...
        <!-- Payment Details -->
          <% if (order_details.getPayment().getPaymentId()!=null) { %>
	        <div class="payment-details-box">
	            ...
	            <div class="payment-info-row">
	                ...
	                <span class="payment-value" id="paymentMethod"><%=order_details.getPayment().getPaymentMethod().getValue() %></span>
	            </div>
           <% } else {
        	   		if (order_details.getOrder().getOrder_status().equals("PENDING")) { %>
